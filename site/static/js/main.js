!function () {
    ...
    var container = document.querySelector(".container"),
        ...
        menu_more_trigger = document.querySelector(".menu-inner-list-more-trigger"),
    ...
    menu_more_trigger &&
        (menu_more_trigger.addEventListener("click", function (event) {
            event.stopPropagation(),
            toggle_menu_more(),
        ...
        menu_more_trigger.addEventListener("keyup", function (event) {
            event.stopPropagation(),
            event.code === "Enter" &&
                toggle_menu_more(),
            menu_more.getBoundingClientRect().right > container.getBoundingClientRect().right &&
